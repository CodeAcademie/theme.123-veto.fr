<?php //123veto ?>
    ...
    <body>
        ...
        <div class="menuNav">
            <!-- logo et nom du site -->
            <a href="<?= get_site_url(); ?>" class="site-logo"><p>123VETO</p></a>
            <!-- menu de navigation -->
            ...
            <div class="icones">
                <?php if(is_user_logged_in()) :?>
                    <a href="<?= get_site_url(); ?>/index.php/mes-rendez-vous"><i class="linkAccueil fa fa-calendar" aria-hidden="true"></i></a>
                <?php endif; ?>
